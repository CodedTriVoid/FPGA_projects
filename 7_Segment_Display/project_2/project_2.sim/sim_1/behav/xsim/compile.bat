...
REM
REM Generated by Vivado on Sun May 24 23:34:46 -0400 2026
...
echo "xvlog --incr --relax -prj project_2_vlog.prj"
call xvlog  --incr --relax -prj project_2_vlog.prj -log xvlog.log
